package com.bohui.art.common.helperutil;
...
public class AbsBaseHelperUtil extends BaseHelperUtil {
    ...
    public BasePowfullDialog getDialog(DialogType type) {
        mCurrentType = type;
        createDialog();
        return mDialog;
    }
    ...
    public void showLoadingDialog() {
        getDialog(DialogType.LOADING).showDialog();
    }
