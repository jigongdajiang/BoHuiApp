package com.jimeijf.smallelement.banner;
...
import com.jimeijf.smallelement.R;
import com.jimeijf.smallelement.banner.adapter.CBPageAdapter;
import com.jimeijf.smallelement.banner.holder.CBViewHolderCreator;
import com.jimeijf.smallelement.banner.listener.CBPageChangeListener;
import com.jimeijf.smallelement.banner.listener.OnItemClickListener;
import com.jimeijf.smallelement.banner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        viewPager = (CBLoopViewPager) hView.findViewById(R.id.cbLoopViewPager22);
    ...
    public ConvenientBanner refreshPages(List<T> datas) {
        if (datas != null) {
            this.mDatas = datas;
            if (pageAdapter != null) {
                if (page_indicatorId != null) {
