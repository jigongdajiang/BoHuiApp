...
import com.jimeijf.core.cache.converter.SerializableDiskConverter;
import com.jimeijf.core.cache.stategy.CacheMode;
import com.jimeijf.core.http.cookie.CookieManger;
import com.jimeijf.core.http.interceptor.HttpLoggingInterceptor;
import com.jimeijf.core.http.model.HttpHeaders;
import com.jimeijf.core.http.model.HttpParams;
import com.jimeijf.core.http.model.IParamConvert;
import com.jimeijf.core.http.request.CustomRequest;
import com.jimeijf.core.http.request.DeleteRequest;
import com.jimeijf.core.http.request.DownloadRequest;
import com.jimeijf.core.http.request.GetRequest;
import com.jimeijf.core.http.request.PostRequest;
import com.jimeijf.core.http.request.PutRequest;
import com.jimeijf.core.http.utils.HttpUtil;
import com.jimeijf.core.http.utils.HttpsUtils;
import com.jimeijf.core.log.PrintLog;
import com.jimeijf.core.rxcore.RxTransform;
...
public final class EasyHttp {
    ...
    private IParamConvert paramConvert;                               //参数转换器
    ...
    public EasyHttp debug(String tag, boolean isPrintException) {
        ...
        PrintLog.COMMONLOGTAG = tempTag;
        PrintLog.allowE = isPrintException;
        PrintLog.allowD = isPrintException;
        PrintLog.allowI = isPrintException;
        PrintLog.allowV = isPrintException;
        return this;
    }
    ...
    public EasyHttp setCacheDiskConverter(IDiskConverter converter) {
        rxCacheBuilder.diskConverter(HttpUtil.checkNotNull(converter, "converter == null"));
        return this;
    }
    ...
    public EasyHttp addInterceptor(Interceptor interceptor) {
        okHttpClientBuilder.addInterceptor(HttpUtil.checkNotNull(interceptor, "interceptor == null"));
        return this;
    }
    ...
    public EasyHttp addNetworkInterceptor(Interceptor interceptor) {
        okHttpClientBuilder.addNetworkInterceptor(HttpUtil.checkNotNull(interceptor, "interceptor == null"));
        return this;
    }
    ...
    public EasyHttp setOkproxy(Proxy proxy) {
        okHttpClientBuilder.proxy(HttpUtil.checkNotNull(proxy, "proxy == null"));
        return this;
    }
    ...
    public EasyHttp setOkconnectionPool(ConnectionPool connectionPool) {
        okHttpClientBuilder.connectionPool(HttpUtil.checkNotNull(connectionPool, "connectionPool == null"));
        return this;
    }
    ...
    public EasyHttp setOkclient(OkHttpClient client) {
        retrofitBuilder.client(HttpUtil.checkNotNull(client, "client == null"));
        return this;
    }
    ...
    public EasyHttp addConverterFactory(Converter.Factory factory) {
        retrofitBuilder.addConverterFactory(HttpUtil.checkNotNull(factory, "factory == null"));
        return this;
    }
    ...
    public EasyHttp addCallAdapterFactory(CallAdapter.Factory factory) {
        retrofitBuilder.addCallAdapterFactory(HttpUtil.checkNotNull(factory, "factory == null"));
        return this;
    }
    ...
    public EasyHttp setCallbackExecutor(Executor executor) {
        retrofitBuilder.callbackExecutor(HttpUtil.checkNotNull(executor, "executor == null"));
        return this;
    }
    ...
    public EasyHttp setCallFactory(okhttp3.Call.Factory factory) {
        retrofitBuilder.callFactory(HttpUtil.checkNotNull(factory, "factory == null"));
        return this;
    }
    ...
    public EasyHttp setBaseUrl(String baseUrl) {
        mBaseUrl = HttpUtil.checkNotNull(baseUrl, "baseUrl == null");
        return this;
    }

    public EasyHttp setEncrypt(boolean encrypt){
        isEncrypt = encrypt;
        return this;
    }
     ...
     * 设置全局参数改造器
     */
    public EasyHttp setParamConvert(IParamConvert pc){
        paramConvert = pc;
        return this;
    }
    /**
    ...
    public static void clearCache() {
        getRxCache().clear().compose(RxTransform.<Boolean>io_main())
                .subscribe(new Consumer<Boolean>() {
                    @Override
                    public void accept(@NonNull Boolean aBoolean) throws Exception {
                        PrintLog.i("clearCache success!!!");
                    }
                }, new Consumer<Throwable>() {
                    @Override
                    public void accept(@NonNull Throwable throwable) throws Exception {
                        PrintLog.i("clearCache err!!!");
                    }
                });
    }
    ...
    public static void removeCache(String key) {
        getRxCache().remove(key).compose(RxTransform.<Boolean>io_main()).subscribe(new Consumer<Boolean>() {
            @Override
            public void accept(@NonNull Boolean aBoolean) throws Exception {
