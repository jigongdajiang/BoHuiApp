...
import com.jimeijf.core.http.callback.DownloadProgressCallBack;
...
public class DownloadSubscriber<ResponseBody extends okhttp3.ResponseBody> extends BaseSubscriber<ResponseBody> {
    ...
    private static String fileSuffix = "";//后缀
    private long lastRefreshUiTime;//最后刷新时间
    ...
    public void onError(final ApiException e) {
        PrintLog.d("DownSubscriber:>>>> onError:" + e.getMessage());
        finalonError(e);
    }
    ...
    private boolean writeResponseBodyToDisk(String path, String name, Context context, okhttp3.ResponseBody body) {
        PrintLog.d("contentType:>>>>" + body.contentType().toString());
        ...
        try {
           ...
           /* if (!futureStudioIconFile.exists()) {
            ...
            try {
                ...
                PrintLog.d("file length: " + fileSize);
                ...
                while (true) {
                    ...
                    PrintLog.i("file download: " + fileSizeDownloaded + " of " + fileSize);
                    //下载进度
                ...
                outputStream.flush();
                PrintLog.i("file downloaded: " + fileSizeDownloaded + " of " + fileSize);
                ...
                if (callBack != null) {
                    ...
                    PrintLog.i("file downloaded: " + fileSizeDownloaded + " of " + fileSize);
                    PrintLog.i("file downloaded: is sucess");
                }
    ...
    /**
     * 下的的错误不管啥原因，最终以一个状态码为100的APIException返回
     * @param e
     */
    private void finalonError(final Exception e) {
        ...
        Observable.just(new ApiException(e, 100))
                .observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<ApiException>() {
            @Override
