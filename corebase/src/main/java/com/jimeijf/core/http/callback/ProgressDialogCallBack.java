...
import com.jimeijf.core.http.subsciber.IProgressDialog;
import com.jimeijf.core.http.subsciber.ProgressCancelListener;
...
public abstract class ProgressDialogCallBack<T> extends CallBack<T> implements ProgressCancelListener {
    private IProgressDialog progressDialog;//实现该接口就可通用Dialog层
