...
package com.jimeijf.core.http.interceptor;
...
import static com.jimeijf.core.http.utils.HttpUtil.UTF8;


/**
 * <p>描述：判断响应是否有效的处理的基类</p>
...
public abstract class BaseExpiredInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        PrintLog.i("网络拦截器:" + bodyString + " host:" + request.url().toString());
